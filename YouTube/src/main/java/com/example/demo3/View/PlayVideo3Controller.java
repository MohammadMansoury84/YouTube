...
public class PlayVideo3Controller {
    private static PlayVideo3Controller instance;

    public PlayVideo3Controller(){
        instance = this;
    }
    public static PlayVideo3Controller getInstance() {
        return instance;
    }
